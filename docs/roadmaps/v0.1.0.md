# Provado Development Roadmap — v0.1.0

> **Status: SHIPPED** as git tag `0.1.0`. This is the historical roadmap for the
> v0.1.0 milestone (Phases 0–12 below). The active roadmap is `docs/roadmaps/v0.2.0.md`.
...
or a demo entry point (deferred to v0.2.0).
...
patterns, no real provider calls, no demo entry point (deferred to v0.2.0).
