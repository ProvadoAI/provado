# Opportunity: Revenue Risk Anticipation

## Summary

Revenue Risk Anticipation is the capability to detect evolving ecommerce conditions that are likely to cause future revenue degradation before the loss is clearly visible in sales metrics.
